...
export const listingCasinos: ListingCasino[] = [
  ...
  },
  {
    ...
    logo: "/logos/rivo.png",
    rating: 4.9,
    bonus: "1000% tot €10.000",
    freeSpins: "25% cashback",
    minDeposit: "€20",
    license: "Curaçao",
    payoutSpeed: "~30 min",
    pros: [
      "Slots-bonus 1000% tot €10.000",
      "25% cashback op verlies",
      "4000+ spellen, live casino én sport",
    ],
    cta: "https://go.afftrackio.com/visit/?bta=36512&nci=5386",
  },
  {
    rank: 4,
    name: "Seven",
    slug: "seven",
    logo: "/logos/seven.png",
    rating: 4.8,
    bonus: "450% tot €7.500",
    freeSpins: "10% cashback",
    minDeposit: "€20",
    license: "Curaçao",
    payoutSpeed: "~35 min",
    pros: [
      "Meertraps welkomstpakket tot €7.500",
      "Lage wager van 10x",
      "Slots, tafelspellen en live dealer",
    ],
    cta: "https://go.afftrackio.com/visit/?bta=36512&nci=5375",
  },
  {
