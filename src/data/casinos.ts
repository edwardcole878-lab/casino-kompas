...
export const casinos: Casino[] = [
  {
    ...
    verdict: "Betory levert wat het belooft: grote bonus, snelle uitbetalingen, breed aanbod. Topkeuze in de Anjouan-categorie.",
    intro: "Betory is een crypto-first online casino actief sinds 2023. Het platform combineert moderne UX met een van de grootste welkomstbonussen die je momenteel buiten de KSA-vergunde markt vindt.",
  ...
  },
  {
    ...
    pros: ["Sterkste live casino-aanbod in deze prijsklasse", "Pure cashbonus zonder spins-ruis", "Dagelijkse reload-promoties", "Snelle uitbetalingen < 6 uur via crypto", "Live casino telt 100% mee voor wagering — zeldzaam"],
  ...
  },
  {
    ...
    tagline: "Tropisch thema met €1.000 over 2 stortingen",
    rating: 8.4,
    bonusHeadline: "Tot €1.000 + 100 Free Spins",
    bonusDetail: "Welkomstpakket gespreid over eerste 2 stortingen.",
    maxBonus: 1000,
    wagering: "35x B",
    lastTested: "2026-04-07",
    ctaLabel: "Speel Nu",
    logoUrl: "/casino-logos/winnerisland.png",
    benefits: ["Bonus gespreid over 2 stortingen", "Casino + sportsbook in één account", "Marktconforme 35x wagering"],
    payments: ["iDEAL", "Trustly", "Visa", "Mastercard", "Skrill", "Crypto"],
    payoutTime: "Onder 12 uur",
    minDeposit: "€15",
    licence: "Anjouan Gaming License",
    ...
    brandColor: "oklch(0.65 0.15 200)",
    pros: ["Pakket gespreid over twee stortingen — minder druk", "Marktconforme 35x wagering", "Sportsbook met goede pre-match en live odds", "Vrolijk tropisch thema dat afwijkt", "Casino + sportsbook gecombineerd"],
    cons: ["Recent gelanceerd (2025) — beperkte trackrecord", "Slot-bibliotheek kleiner dan grote concurrenten", "Geen Nederlandse support"],
    verdict: "WinnerIsland is een prima tweede-keuze voor wie de grotere namen al heeft geprobeerd, met laagdrempelige gespreide bonus.",
    intro: "WinnerIsland Casino is een van de nieuwste Anjouan-platforms in deze lijst — gelanceerd begin 2025 met een tropisch strand-design dat opvalt.",
    games: { slots: 2800, live: 100, table: 50 },
    providers: ["Pragmatic Play", "NetEnt", "Hacksaw Gaming", "Play'n GO", "Evolution"],
    licences: ["Anjouan"],
    bonusTypes: ["welkomstbonus", "free-spins", "reload"],
    owner: "WinnerIsland Operations",
    affiliateUrl: "#",
  },
  {
    slug: "vivaspin",
