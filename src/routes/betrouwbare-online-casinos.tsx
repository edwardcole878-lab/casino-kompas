...
export const Route = createFileRoute("/betrouwbare-online-casinos")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Veiligheid eerst: alle casino's met KSA-licentie, bewezen uitbetalingen, Cruks-koppeling en duidelijke spelersbescherming." },
  ...
  return (
    <CategoryPage
      ...
      faqs={[
        ...
        { q: "Wat is een 'AGOG' of 'AGCC' licentie?", a: "Buitenlandse licenties die in Nederland sinds oktober 2021 niet meer geldig zijn. Speel uitsluitend bij KSA-vergunde casino's." },
